...
<@pp.changeOutputFile  name="../"+className+"/"+className+"Edit.html" />
                ...
                <div class="row">
                    ...
                    <!-- PAGE CONTENT BEGINS -->
                        ...
                        <UL id="myTab" class="nav nav-tabs">
                            ...
                            <li class="active">
                                <a href="#tab_id01"  data-toggle="tab"><i class="icon-edit blue"></i>修改</a>
                            </li>
                        </UL>
                            ...
                            <DIV id="tab_id01" class="tab-pane fade in active">
                                ...
                                <DIV class="row">
                                    ...
                                    <div class="col-md-8" style="border:1px dashed #f0f0f0">
                                        ...
                                        <form id="updateForm"  name="updateForm"  class="form-horizontal"  th:action="@{/${classNameLower}/update}" th:object="${dollar}{${classNameLower}}"  action="#"  method="post">
